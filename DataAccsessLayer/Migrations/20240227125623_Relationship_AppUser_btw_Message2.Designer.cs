...
namespace DataAccsessLayer.Migrations
{
    ...
    [Migration("20240227125623_Relationship_AppUser_btw_Message2")]
    partial class Relationship_AppUser_btw_Message2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.AppUser", b =>
                {
                    ...
                    b.HasIndex("WriterID")
                        .IsUnique()
                        .HasFilter("[WriterID] IS NOT NULL");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("EntityLayer.Concrete.Writer", "Writer")
                        .WithOne("AppUser")
                        .HasForeignKey("EntityLayer.Concrete.AppUser", "WriterID");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Message2", b =>
                {
                    b.HasOne("EntityLayer.Concrete.AppUser", "ReceiverUserr")
                    ...
                    b.HasOne("EntityLayer.Concrete.AppUser", "SenderUserr")
                    ...
                    b.Navigation("ReceiverUserr");

                    b.Navigation("SenderUser");

                    b.Navigation("SenderUserr");
                });
